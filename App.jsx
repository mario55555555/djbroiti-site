...
const content = {
  en: {
    ...
    brandHebrew: "ברויטי",
    heroBadge: "Official Website",
    heroTitle1: "Music That Feels",
    heroTitle2: "Like Cinema",
    heroText:
      "A cinematic music experience blending sound, visuals, and emotion — all in one place.",
    watchFeatured: "Open on YouTube",
    exploreArchive: "Explore Archive",
    streamMusic: "Streaming Platforms",
    featured: "Featured Release",
    watchYoutube: "Watch on YouTube",
    archiveTitle: "Full Archive",
    archiveText:
      "Official videos, originals, remixes, and cinematic releases — curated in one premium collection.",
    contactTitle: "Contact",
    contactText: "For collaborations, music, and official inquiries:",
    aboutTitle: "About",
    aboutText:
      "DJ Broiti is an AI music artist from Jerusalem creating electronic music, cinematic sound, and visual storytelling experiences.",
    aboutText2:
      "This official site brings together the music, clips, and world of DJ Broiti in one place.",
  ...
  he: {
    ...
    brandHebrew: "ברויטי",
    heroBadge: "האתר הרשמי",
    heroTitle1: "מוזיקה שנשמעת",
    heroTitle2: "כמו סרט",
    heroText:
      "החוויה הקולנועית של DJ Broiti — מוזיקה, ויז'ואל ורגש במקום אחד.",
    watchFeatured: "פתח ביוטיוב",
    exploreArchive: "לארכיון המלא",
    streamMusic: "פלטפורמות סטרימינג",
    featured: "קטע נבחר",
    watchYoutube: "צפה ביוטיוב",
    archiveTitle: "הארכיון המלא",
    archiveText:
      "קליפים רשמיים, שירים מקוריים, רמיקסים והוצאות קולנועיות — כולם במקום אחד.",
    contactTitle: "יצירת קשר",
    contactText: "לשיתופי פעולה, מוזיקה ופניות רשמיות:",
    aboutTitle: "אודות",
    aboutText:
      "DJ Broiti הוא אמן מוזיקה מבוססת בינה מלאכותית מירושלים היוצר מוזיקה אלקטרונית, סאונד קולנועי וחוויות ויזואליות.",
    aboutText2:
...
function SocialIconLink({ href, children, hideOnMobile = false }) {
  return (
    <a
      ...
      } w-10 h-10 rounded-full border border-white/10 bg-white/5 items-center justify-center text-white/70 hover:text-[#c9a96e] hover:border-[#c9a96e]/40 hover:bg-[#c9a96e]/10 transition-all duration-300`}
    >
      {children}
    </a>
  );
...
function StatCard({ value, label }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-4 backdrop-blur-sm">
      <div className="text-2xl md:text-3xl font-semibold text-[#e9d4ac]">
        {value}
      </div>
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-4 flex items-center justify-between gap-4">
          <div className={`flex items-center gap-3 ${isHebrew ? "flex-row-reverse" : ""}`}>
            ...
            <div className={isHebrew ? "text-right" : "text-left"}>
              ...
              <div
                className={`text-[10px] tracking-[0.28em] text-white/38 ${
                  isHebrew ? "" : "uppercase"
                }`}
              >
      ...
      <main className="relative z-10">
            ...
            >
              <div className="mb-8">
                <div className={`max-w-3xl ${isHebrew ? "mr-auto text-right" : "ml-auto text-left"}`}>
                  ...
                  <div className={`mt-5 max-w-2xl text-sm md:text-base leading-8 text-white/65 ${isHebrew ? "mr-auto" : ""}`}>
                    {t.heroText}
                  </div>
                </div>
              </div>
        ...
        <section className="px-6 pb-10">
          <div className="max-w-7xl mx-auto">
            <div className="rounded-[26px] border border-white/10 bg-white/[0.03] p-5 md:p-6">
              <div className={`flex flex-col md:flex-row md:items-center md:justify-between gap-5 ${isHebrew ? "md:flex-row-reverse" : ""}`}>
                <div className={isHebrew ? "text-right" : "text-left"}>
                ...
                <div className={`flex flex-wrap gap-3 ${isHebrew ? "md:justify-start" : "md:justify-end"}`}>
                  <a
        ...
        <section id="archive" className="px-6 pb-16">
          <div className="max-w-7xl mx-auto">
            <div className={`mb-8 ${isHebrew ? "text-right" : "text-left"}`}>
              <div className="text-[11px] uppercase tracking-[0.35em] text-[#c9a96e] mb-3">
                {isHebrew ? "האוסף המלא" : "Full Collection"}
              </div>
      ...
      <footer className="relative z-10 border-t border-white/10 px-6 py-12 mt-8">
        <div
          className={`max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5 ${
        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <FooterIconLink href="https://www.instagram.com/djbroiti/">
              <InstagramIcon />
            </FooterIconLink>
            <FooterIconLink href="https://www.tiktok.com/@djbroiti">
              <TiktokIcon />
            </FooterIconLink>
          </div>
        </div>
